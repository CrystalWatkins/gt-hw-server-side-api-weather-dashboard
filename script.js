...
function displayWeatherInfo(event, element) {
   ...
   $.ajax({
    ...
    $("#temp2").append("Temp: " + response3.list[1].main.temp + "°F");
    ...
    $("#temp3").append("Temp: " + response3.list[2].main.temp + "°F");
    ...
    $("#temp4").append("Temp: " + response3.list[3].main.temp + "°F");
    ...
    $("#temp5").append("Temp: " + response3.list[4].main.temp + "°F");
